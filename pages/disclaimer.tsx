...
const Disclaimer: NextPageWithLayout = () => {
  return (
    <Layout>
      <Head>
        <title>アプリ利用規約　セツヤク‼️</title>
      </Head>
      <SubLayout>
        <div className="pb-5 mb-5 d-grid gap-2">
          <h1 className='text-center'>アプリ利用規約</h1>
          <p>この利用規約は、このアプリにて提供するサービスの利用条件を定めるものです。ユーザーは本規約を遵守することで、このアプリをご利用いただけます。</p>
          ...
          <p>プライバシー保護方針については、<Link href="">プライバシーポリシー</Link>にて記載しています。</p>
          ...
          <p><Link href="">利用規約</Link>を遵守いただきますようよろしくお願いいたします。</p>
        </div>
      </SubLayout>
    </Layout>
  )
